void NodeChromaSDK::_register_methods() {
	...
	register_method((char*)"AddColor", &NodeChromaSDK::AddColor);
	//register_method((char*)"AddFrame", &NodeChromaSDK::AddFrame);
	register_method((char*)"AddNonZeroAllKeys", &NodeChromaSDK::AddNonZeroAllKeys);
	...
	register_method((char*)"AddNonZeroAllKeysName", &NodeChromaSDK::AddNonZeroAllKeysName);
	...
	register_method((char*)"CopyZeroAllKeys", &NodeChromaSDK::CopyZeroAllKeys);
	...
	register_method((char*)"CopyZeroAllKeysName", &NodeChromaSDK::CopyZeroAllKeysName);
	register_method((char*)"CopyZeroAllKeysOffset", &NodeChromaSDK::CopyZeroAllKeysOffset);
	register_method((char*)"CopyZeroAllKeysOffsetName", &NodeChromaSDK::CopyZeroAllKeysOffsetName);
	...
	register_method((char*)"CopyZeroTargetAllKeys", &NodeChromaSDK::CopyZeroTargetAllKeys);
	...
	register_method((char*)"CopyZeroTargetAllKeysName", &NodeChromaSDK::CopyZeroTargetAllKeysName);
	...
	register_method((char*)"CoreStreamBroadcast", &NodeChromaSDK::CoreStreamBroadcast);
	register_method((char*)"CoreStreamBroadcastEnd", &NodeChromaSDK::CoreStreamBroadcastEnd);
	//register_method((char*)"CoreStreamGetAuthShortcode", &NodeChromaSDK::CoreStreamGetAuthShortcode);
	//register_method((char*)"CoreStreamGetFocus", &NodeChromaSDK::CoreStreamGetFocus);
	//register_method((char*)"CoreStreamGetId", &NodeChromaSDK::CoreStreamGetId);
	//register_method((char*)"CoreStreamGetKey", &NodeChromaSDK::CoreStreamGetKey);
	register_method((char*)"CoreStreamGetStatus", &NodeChromaSDK::CoreStreamGetStatus);
	register_method((char*)"CoreStreamGetStatusString", &NodeChromaSDK::CoreStreamGetStatusString);
	register_method((char*)"CoreStreamReleaseShortcode", &NodeChromaSDK::CoreStreamReleaseShortcode);
	register_method((char*)"CoreStreamSetFocus", &NodeChromaSDK::CoreStreamSetFocus);
	register_method((char*)"CoreStreamSupportsStreaming", &NodeChromaSDK::CoreStreamSupportsStreaming);
	register_method((char*)"CoreStreamWatch", &NodeChromaSDK::CoreStreamWatch);
	register_method((char*)"CoreStreamWatchEnd", &NodeChromaSDK::CoreStreamWatchEnd);
	...
	//register_method((char*)"GetFrameName", &NodeChromaSDK::GetFrameName);
	...
	register_method((char*)"SubtractColor", &NodeChromaSDK::SubtractColor);
	register_method((char*)"SubtractNonZeroAllKeys", &NodeChromaSDK::SubtractNonZeroAllKeys);
	...
	register_method((char*)"SubtractNonZeroAllKeysName", &NodeChromaSDK::SubtractNonZeroAllKeysName);
	...
	register_method((char*)"SubtractThresholdColorsMinMaxAllFramesRGB", &NodeChromaSDK::SubtractThresholdColorsMinMaxAllFramesRGB);
	register_method((char*)"SubtractThresholdColorsMinMaxAllFramesRGBName", &NodeChromaSDK::SubtractThresholdColorsMinMaxAllFramesRGBName);
	register_method((char*)"SubtractThresholdColorsMinMaxAllFramesRGBNameD", &NodeChromaSDK::SubtractThresholdColorsMinMaxAllFramesRGBNameD);
	register_method((char*)"SubtractThresholdColorsMinMaxRGB", &NodeChromaSDK::SubtractThresholdColorsMinMaxRGB);
	register_method((char*)"SubtractThresholdColorsMinMaxRGBName", &NodeChromaSDK::SubtractThresholdColorsMinMaxRGBName);
	register_method((char*)"SubtractThresholdColorsMinMaxRGBNameD", &NodeChromaSDK::SubtractThresholdColorsMinMaxRGBNameD);
	...
	register_method((char*)"UnloadLibrarySDK", &NodeChromaSDK::UnloadLibrarySDK);
	register_method((char*)"UnloadLibraryStreamingPlugin", &NodeChromaSDK::UnloadLibraryStreamingPlugin);
...
*/
ChromaSDK::Stream::StreamStatusType godot::NodeChromaSDK::CoreStreamGetStatus()
{
	return ChromaAnimationAPI::CoreStreamGetStatus();
}

/*
	Convert StreamStatusType to a printable string
*/
const char* godot::NodeChromaSDK::CoreStreamGetStatusString(ChromaSDK::Stream::StreamStatusType status)
{
	return ChromaAnimationAPI::CoreStreamGetStatusString(status);
}
...
{
	return ChromaAnimationAPI::SetEffectKeyboardCustom2D(device, colors, keys);
}
