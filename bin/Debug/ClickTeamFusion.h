#pragma region Autogenerated lua C functions
	...
	*/
	static int LuaAddColor(lua::lua_State* state);
	/*
	...
	*/
	static int LuaAddNonZeroAllKeys(lua::lua_State* state);
	/*
	...
	*/
	...
	Add source color to target where color is not black for frame id, reference 
		source and target by name.
	*/
	static int LuaAddNonZeroAllKeysName(lua::lua_State* state);
	/*
	...
	*/
	...
	Copy zero colors from source animation to target animation for the frame. 
		Source and target are referenced by id.
	*/
	static int LuaCopyZeroAllKeys(lua::lua_State* state);
	/*
	...
	*/
	...
	Copy zero colors from source animation to target animation for the frame. 
		Source and target are referenced by name.
	*/
	static int LuaCopyZeroAllKeysName(lua::lua_State* state);
	/*
	Copy zero colors from source animation to target animation for the frame 
		id starting at the target offset for the length of the source animation. 
		Source and target are referenced by id.
	*/
	static int LuaCopyZeroAllKeysOffset(lua::lua_State* state);
	/*
	Copy zero colors from source animation to target animation for the frame 
		id starting at the target offset for the length of the source animation. 
		Source and target are referenced by name.
	*/
	static int LuaCopyZeroAllKeysOffsetName(lua::lua_State* state);
	/*
	...
	*/
	static int LuaCopyZeroTargetAllKeys(lua::lua_State* state);
	/*
	Copy nonzero color from source animation to target animation where target 
	...
	*/
	static int LuaCopyZeroTargetAllKeysName(lua::lua_State* state);
	/*
	...
	*/
	static int LuaCoreStreamBroadcast(lua::lua_State* state);
	/*
	End broadcasting Chroma RGB data. StreamGetStatus() should return the BROADCASTING 
		status to use this method.
	*/
	static int LuaCoreStreamBroadcastEnd(lua::lua_State* state);
	/*
	...
	*/
	static int LuaCoreStreamGetAuthShortcode(lua::lua_State* state);
	/*
	...
	*/
	static int LuaCoreStreamGetFocus(lua::lua_State* state);
	/*
	...
	*/
	static int LuaCoreStreamGetId(lua::lua_State* state);
	/*
	Intended for Cloud Gaming Platforms, store the streaming key to persist 
		...
		expires. StreamGetStatus() should return the READY status to use this method.
	*/
	static int LuaCoreStreamGetKey(lua::lua_State* state);
	/*
	Returns StreamStatus, the current status of the service
	*/
	static int LuaCoreStreamGetStatus(lua::lua_State* state);
	/*
	Convert StreamStatusType to a printable string
	*/
	static int LuaCoreStreamGetStatusString(lua::lua_State* state);
	/*
	...
	*/
	static int LuaCoreStreamReleaseShortcode(lua::lua_State* state);
	/*
	The focus is a null terminated string. Set the focus identifer for the application 
		...
		success.
	*/
	static int LuaCoreStreamSetFocus(lua::lua_State* state);
	/*
	Returns true if the Chroma streaming is supported. If false is returned, 
		avoid calling stream methods.
	*/
	static int LuaCoreStreamSupportsStreaming(lua::lua_State* state);
	/*
	...
	*/
	...
	Get the frame colors and duration (in seconds) for a `Chroma` animation 
		...
		Returns the animation id upon success. Returns negative one upon failure.
	*/
	static int LuaGetFrameName(lua::lua_State* state);
	/*
	...
	*/
	static int LuaSubtractColor(lua::lua_State* state);
	/*
	...
	*/
	static int LuaSubtractNonZeroAllKeys(lua::lua_State* state);
	/*
	...
	*/
	...
	Subtract the source color from the target color for the frame where the 
		target color is not black. Source and target are referenced by name.
	*/
	static int LuaSubtractNonZeroAllKeysName(lua::lua_State* state);
	/*
	...
	*/
	...
	Subtract all frames with the min RGB color where the animation color is 
		...
		is more than the max threshold. Animation is referenced by id.
	*/
	static int LuaSubtractThresholdColorsMinMaxAllFramesRGB(lua::lua_State* state);
	/*
	Subtract all frames with the min RGB color where the animation color is 
		less than the min threshold AND with the max RGB color where the animation 
		is more than the max threshold. Animation is referenced by name.
	*/
	static int LuaSubtractThresholdColorsMinMaxAllFramesRGBName(lua::lua_State* state);
	/*
	D suffix for limited data types.
	*/
	static int LuaSubtractThresholdColorsMinMaxAllFramesRGBNameD(lua::lua_State* state);
	/*
	...
	*/
	static int LuaSubtractThresholdColorsMinMaxRGB(lua::lua_State* state);
	/*
	Subtract the specified frame with the min RGB color where the animation 
		color is less than the min threshold AND with the max RGB color where the 
		animation is more than the max threshold. Animation is referenced by name.
	*/
	static int LuaSubtractThresholdColorsMinMaxRGBName(lua::lua_State* state);
	/*
	D suffix for limited data types.
	*/
	static int LuaSubtractThresholdColorsMinMaxRGBNameD(lua::lua_State* state);
	/*
	...
	*/
	static int LuaUnloadLibrarySDK(lua::lua_State* state);
	/*
	Unload the Razer Chroma Streaming Plugin Library before exiting the application.
	*/
	static int LuaUnloadLibraryStreamingPlugin(lua::lua_State* state);
	/*
