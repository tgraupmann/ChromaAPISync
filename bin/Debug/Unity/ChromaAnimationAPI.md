...
```charp
UnityNativeChromaSDK.CopyKeysColorAllFrames(int sourceAnimationId, int targetAnimationId, int[] keys, int size);
```
...
```charp
UnityNativeChromaSDK.CopyKeysColorAllFramesName(string sourceAnimation, string targetAnimation, int[] keys, int size);
```
...
```charp
int result = UnityNativeChromaSDK.CoreInit();
```
...
```charp
int result = UnityNativeChromaSDK.CoreUnInit();
```
...
```charp
int result = UnityNativeChromaSDK.CreateEffect(Guid deviceId, EFFECT_TYPE effect, int[] colors, int size, out FChromaSDKGuid effectId);
```
...
```charp
int result = UnityNativeChromaSDK.DeleteEffect(Guid effectId);
```
...
```charp
int result = UnityNativeChromaSDK.GetFrame(int animationId, int frameIndex, out float duration, int[] colors, int length, int[] keys, int keysLength);
```
...
```charp
int result = UnityNativeChromaSDK.GetLibraryLoadedState();
```
...
```charp
int result = UnityNativeChromaSDK.SetEffectKeyboardCustom2D(int device, int[] colors, int[] keys);
```
...
```charp
int result = UnityNativeChromaSDK.UpdateFrame(int animationId, int frameIndex, float duration, int[] colors, int length, int[] keys, int keysLength);
```
...
```charp
int result = UnityNativeChromaSDK.UpdateFrameName(string path, int frameIndex, float duration, int[] colors, int length, int[] keys, int keysLength);
```
